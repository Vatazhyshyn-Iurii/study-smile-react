  ...
  return (
    <div>
      ...
      <form>
        ...
        <label>
          {' '}
          Target item css properties (like: position: relative, width: 70px,
          height: 70px, background: #ff4100):
          <input
            style={{ display: 'block', width: '90%' }}
            type="text"
            name="dustbinStyles"
        ...
        <label>
          {' '}
          Item css properties (like: position: relative, width: 70px, height:
          70px, background: #ff4100):
          <input
            style={{ display: 'block', width: '90%' }}
            type="text"
            name="boxStyles"
